        ...
        <nav className="navbar">
            ...
            <div className="sign-in">
                <button
                    ...
                    onMouseLeave={() => setHovered(false)}>Sign in{isHovered ? <IoMdArrowForward /> : <IoIosArrowForward />}</button>
            </div>
        </nav>
    );
}
